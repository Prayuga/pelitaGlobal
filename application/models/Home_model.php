...
class Home_model extends CI_Model {	
	...
	public function get_ultah(){
        $str = "select a.NamaSiswa, DATE_FORMAT(a.TanggalLahir, '%e %M %Y') as TanggalLahir,b.SingkatanKategori, c.NamaKelas from mssiswa as a, mskategorikelas as b, msheaderkelas as c WHERE a.ID_Kategori = b.ID_Kategori and a.ID_Kelas = c.ID_Kelas and month(a.TanggalLahir) = month(CURRENT_DATE) and date(a.TanggalLahir) = date(CURRENT_DATE) and a.FlagActive = 'Y'";
